...
void GPIO_voidSetPinMode(u8 Copy_u8PortID  , u8 Copy_u8Pin ,u8 Copy_u8PinMode)
{
	...
	case Digital_input:
		...
		case GPIO_Port_A:
			...
			CLR_BIT(GPIOA->MODER,Local_u8Location);
			CLR_BIT(GPIOA->MODER,(Local_u8Location+1));
			break;
		case GPIO_Port_B:
			CLR_BIT(GPIOB->MODER,Local_u8Location);
			CLR_BIT(GPIOB->MODER,(Local_u8Location+1));
			break;
		case GPIO_Port_C:
			CLR_BIT(GPIOC->MODER,Local_u8Location);
			CLR_BIT(GPIOC->MODER,(Local_u8Location+1));
			break;
		}
		break;
		...
		case Digital_output:
			...
			case GPIO_Port_A:
				...
				SET_BIT(GPIOA->MODER,Local_u8Location);
				CLR_BIT(GPIOA->MODER,(Local_u8Location+1));
				break;
			case GPIO_Port_B:
				SET_BIT(GPIOB->MODER,Local_u8Location);
				CLR_BIT(GPIOB->MODER,(Local_u8Location+1));
				break;
			case GPIO_Port_C:
				SET_BIT(GPIOC->MODER,Local_u8Location);
				CLR_BIT(GPIOC->MODER,(Local_u8Location+1));
				break;
			}
			break;
			...
			case Alternative_func:
				switch(Copy_u8PortID)
				{
				case GPIO_Port_A:

					CLR_BIT(GPIOA->MODER,Local_u8Location);
					SET_BIT(GPIOA->MODER,(Local_u8Location+1));
					break;
				case GPIO_Port_B:
					CLR_BIT(GPIOB->MODER,Local_u8Location);
					SET_BIT(GPIOB->MODER,(Local_u8Location+1));
					break;
				case GPIO_Port_C:
					CLR_BIT(GPIOC->MODER,Local_u8Location);
					SET_BIT(GPIOC->MODER,(Local_u8Location+1));
					break;
				}
				break;
