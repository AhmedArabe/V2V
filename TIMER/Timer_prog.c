...
void MTimer_voidInit (u8 A_u8TimerSelected)
{
	...
	MRCC_vEnableClock(RCC_AHB1 , RCC_GPIO_B) ;
	...
	case TIM1_TYPE  :
		...
		MGPIO_Config_t PIN8 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin8 , .mode = Alternative_func ,
				.output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN8);

		/*configer PA9 as alt fun (T1C2)*/


		MGPIO_Config_t PIN9 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin9 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN9);

		/*configer PA10 as alt fun (T1C3)*/

		MGPIO_Config_t PIN10 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin10 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN10);

		/*configer PA11 as alt fun (T1C4)*/

		MGPIO_Config_t PIN11 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin11 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN11);
...
#error "REPETATION_COUNTER out of range"
	...
	case TIM2_TYPE  :
		...
		MGPIO_Config_t PIN5 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin5 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN5);

		/*configer PA1 as alt fun (T2C2)*/

		MGPIO_Config_t PIN3_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin3 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN3_B);

		/*configer PA2 as alt fun (T2C3)*/

		MGPIO_Config_t PIN10_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin10 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN10_B);

		/*configer PA4 as alt fun (T2C4)*/

		MGPIO_Config_t PIN3 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin3 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF1 };
		MGPIO_vInit(&PIN3);
...
#error "TIM2_PRELOAD_VALUE out of range"
	...
	case TIM3_TYPE  :
		...
		MGPIO_Config_t PIN6 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin6 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN6);
		...
		MGPIO_Config_t PIN7 ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin7 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN7);

		/*configer PA8 as alt fun (T3C3)*/


		MGPIO_Config_t PIN0_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin0 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN0_B);

		/*configer PA9 as alt fun (T3C4)*/

		MGPIO_Config_t PIN1_B ={.Port_ID = GPIO_Port_B, .Pin_ID =GPIO_Pin1 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN1_B);
...
#error "TIM3_PRELOAD_VALUE out of range"
	...
	case TIM4_TYPE  :
		...
		MGPIO_Config_t PIN6_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin6 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN6_B);


		/*configer PB7 as alt fun (T4C2)*/
		MGPIO_Config_t PIN7_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin7 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN7_B);


		/*configer PB8 as alt fun (T4C3)*/
		MGPIO_Config_t PIN8_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin8 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN8_B);


		/*configer PB9 as alt fun (T4C4)*/
		MGPIO_Config_t PIN9_B ={.Port_ID = GPIO_Port_B , .Pin_ID =GPIO_Pin9 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN9_B);
...
#error "TIM4_PRELOAD_VALUE out of range"
	...
	case TIM5_TYPE  :
		...
		MGPIO_Config_t PIN0_A ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin0 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN0_A);


		/*configer PA1 as alt fun (T5C2)*/
		MGPIO_Config_t PIN1_A ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin1 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
		MGPIO_vInit(&PIN1_A);


		/*configer PA2 as alt fun (T5C3)*/
		MGPIO_Config_t PIN2_A ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin2 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
			MGPIO_vInit(&PIN2_A);


		/*configer PA3 as alt fun (T5C4)*/
			MGPIO_Config_t PIN3_A ={.Port_ID = GPIO_Port_A , .Pin_ID =GPIO_Pin3 , .mode = Alternative_func , .output_type = Push_pull , .output_speed = Low , .Alt_func = AF2 };
				MGPIO_vInit(&PIN3_A);
